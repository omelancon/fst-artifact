...
plot \
   'gambit_time_nun_redrock.csv' u 2:3:4:xtic(1) title 'self-tagging (1-tag)' ls 1,\
   'gambit_time_nun_redrock.csv' u 5:6:7:xtic(1) title 'self-tagging (2-tag)' ls 2,\
   'gambit_time_nun_redrock.csv' u 8:9:10:xtic(1) title 'self-tagging (3-tag)' ls 3,\
   'gambit_time_nun_redrock.csv' u 11:12:13:xtic(1) title 'self-tagging (4-tag)' ls 4, \
   'gambit_time_nun_redrock.csv' u ($0+-0.2857142857142857):($4*1.1):(sprintf("%3.2f",$2)) with labels font 'Verdana,4' rotate by 90 notitle,\
   'gambit_time_nun_redrock.csv' u ($0+-0.125):($7*1.1):(sprintf("%3.2f",$5)) with labels font 'Verdana,4' rotate by 90 notitle,\
   'gambit_time_nun_redrock.csv' u ($0+0.125):($10*1.1):(sprintf("%3.2f",$8)) with labels font 'Verdana,4' rotate by 90 notitle,\
   'gambit_time_nun_redrock.csv' u ($0+0.2857142857142857):($13*1.1):(sprintf("%3.2f",$11)) with labels font 'Verdana,4' rotate by 90 notitle
reset

set output 'gambit_time_nun_redrock.pdf'

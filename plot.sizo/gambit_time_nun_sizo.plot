...
plot \
   ...
   'gambit_time_nun_sizo.csv' u ($0+-0.2857142857142857):($2*1.1):(sprintf("%3.2f",$2)) with labels font 'Verdana,4' rotate by 90 notitle,\
   'gambit_time_nun_sizo.csv' u ($0+-0.125):($5*1.1):(sprintf("%3.2f",$5)) with labels font 'Verdana,4' rotate by 90 notitle,\
   'gambit_time_nun_sizo.csv' u ($0+0.125):($8*1.1):(sprintf("%3.2f",$8)) with labels font 'Verdana,4' rotate by 90 notitle,\
   'gambit_time_nun_sizo.csv' u ($0+0.2857142857142857):($11*1.1):(sprintf("%3.2f",$11)) with labels font 'Verdana,4' rotate by 90 notitle
reset

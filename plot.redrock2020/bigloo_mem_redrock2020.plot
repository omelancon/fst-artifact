...
plot \
  ...
  'bigloo_mem_redrock2020.csv' u 6:xtic(1) title '_nun' ls 6,\
  'bigloo_mem_redrock2020.csv' u ($0+-0.3333333333333333):(round(($2+0.1)*10.0) / 10.0):(sprintf("%3.2f",$2)) with labels font 'Verdana,6' rotate by 90 notitle,\
  'bigloo_mem_redrock2020.csv' u ($0+-0.16666666666666666):(round(($3+0.1)*10.0) / 10.0):(sprintf("%3.2f",$3)) with labels font 'Verdana,6' rotate by 90 notitle,\
  'bigloo_mem_redrock2020.csv' u ($0+0):(round(($4+0.1)*10.0) / 10.0):(sprintf("%3.2f",$4)) with labels font 'Verdana,6' rotate by 90 notitle,\
  'bigloo_mem_redrock2020.csv' u ($0+0.16666666666666666):(round(($5+0.1)*10.0) / 10.0):(sprintf("%3.2f",$5)) with labels font 'Verdana,6' rotate by 90 notitle,\
  'bigloo_mem_redrock2020.csv' u ($0+0.3333333333333333):(round(($6+0.1)*10.0) / 10.0):(sprintf("%3.2f",$6)) with labels font 'Verdana,6' rotate by 90 notitle

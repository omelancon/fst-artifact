...
plot \
  'bigloo_branch_redrock2020.csv' u 2:xtic(1) title 'Scheme self tagging (2 tags, mantissa low-bits)' ls 2,\
  'bigloo_branch_redrock2020.csv' u 3:xtic(1) title 'Scheme self tagging (3 tags)1' ls 3,\
  'bigloo_branch_redrock2020.csv' u 4:xtic(1) title 'Scheme self tagging (2 tags)' ls 4,\
  'bigloo_branch_redrock2020.csv' u 5:xtic(1) title 'Scheme nan tagging' ls 5,\
  'bigloo_branch_redrock2020.csv' u 6:xtic(1) title '_nun' ls 6,\
  'bigloo_branch_redrock2020.csv' u ($0+-0.3333333333333333):($2*2.0):(sprintf("%3.2f",$2)) with labels font 'Verdana,6' rotate by 90 notitle,\
  'bigloo_branch_redrock2020.csv' u ($0+-0.16666666666666666):($3*2.0):(sprintf("%3.2f",$3)) with labels font 'Verdana,6' rotate by 90 notitle,\
  'bigloo_branch_redrock2020.csv' u ($0+0):($4*2.0):(sprintf("%3.2f",$4)) with labels font 'Verdana,6' rotate by 90 notitle,\
  'bigloo_branch_redrock2020.csv' u ($0+0.16666666666666666):($5*2.0):(sprintf("%3.2f",$5)) with labels font 'Verdana,6' rotate by 90 notitle,\
  'bigloo_branch_redrock2020.csv' u ($0+0.3333333333333333):($6*2.0):(sprintf("%3.2f",$6)) with labels font 'Verdana,6' rotate by 90 notitle

reset

set output 'bigloo_branch_redrock2020.pdf'
